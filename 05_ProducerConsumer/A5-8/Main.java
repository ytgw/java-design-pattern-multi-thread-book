public class Main {
    public static void main(String[] args) {
        ...
        new LazyThread("Lazy-1", table).start();
        new LazyThread("Lazy-2", table).start();
        new LazyThread("Lazy-3", table).start();
        new LazyThread("Lazy-4", table).start();
        new LazyThread("Lazy-5", table).start();
        new LazyThread("Lazy-6", table).start();
        new LazyThread("Lazy-7", table).start();
    }
}
